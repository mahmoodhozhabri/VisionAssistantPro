...
*   **Настройка Markdown:** Добавлена новая опция "Очищать Markdown в чате" в настройках. Если её отключить, пользователи смогут видеть чистый синтаксис Markdown (например, `**`, `#`) в окне чата.
*   **Управление диалогами:** Исправлена проблема, из-за которой окна "Уточнить текст" или чата могли открываться несколько раз или некорректно получать фокус.
*   **Улучшения UX:** Стандартизированы заголовки диалоговых окон открытия файлов на "Открыть". Убраны лишние голосовые сообщения (например, "Открытие меню...") для более плавной работы.
